...
select sp.sname,sp.city,ords.amt,ords.odate
from salespeople as sp inner join orders as ords 
on sp.snum = ords.snum
where amt >2000.0;
...
select count(odate), ords.odate, sp.sname,sp.city
from orders as ords left outer join salespeople as sp 
on ords.snum = sp.snum
group by odate;